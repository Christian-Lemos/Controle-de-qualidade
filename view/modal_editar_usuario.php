...
$(document).ready(function()
{
	...
	$("#edit_usuario_form_login_btn").on('click', function()
	{
		...
		$.ajax
		({
			url : 'controller/atualizadorUsuarios.php',
			method : 'POST',
			data : {campo : 'login', novo : dadonovo, id : id},
	...
	$("#edit_usuario_form_nome_btn").on('click', function()
	{
		...
		({
			url : 'controller/atualizadorUsuarios.php',
			method : 'POST',
			data : {campo : 'nome', novo : dadonovo, id : id},
	...
	$("#edit_usuario_form_email_btn").on('click', function()
	{
		...
		({
			url : 'controller/atualizadorUsuarios.php',
			method : 'POST',
			data : {campo : 'email', novo : dadonovo, id : id},
	...
	$("#edit_usuario_form_senha_btn").on('click', function()
	{
		...
		({
			url : 'controller/atualizadorUsuarios.php',
			method : 'POST',
			data : {campo : 'senha', novo : dadonovo, id : id},
	...
	$("#edit_usuario_form_admin_btn").on('click', function()
	{
		...
		({
			url : 'controller/atualizadorUsuarios.php',
			method : 'POST',
			data : {campo : 'admin', novo : dadonovo, id : id},
